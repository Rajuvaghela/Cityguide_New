...
import misterro.bitnet.com.jaymetals.Fragments.CodeReferal;
import misterro.bitnet.com.jaymetals.Fragments.Home;
import misterro.bitnet.com.jaymetals.Fragments.Setting;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_setting) {
            getSupportFragmentManager().beginTransaction()
                    .addToBackStack(null)
                    .replace(R.id.main_container, new Setting())
                    .commit();

        } else if (id == R.id.nav_referal_code) {
            getSupportFragmentManager().beginTransaction()
                    .addToBackStack(null)
                    .replace(R.id.main_container, new CodeReferal())
                    .commit();
